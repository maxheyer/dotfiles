...
paq {'kristijanhusak/deoplete-phpactor'}
...
vim.env.FZF_DEFAULT_COMMAND = 'rg --files --no-ignore --hidden --follow --no-messages "" .'
g['rg_derive_root'] = true

-------------------- MAPPINGS ------------------------------
map('n', 'zz', '<cmd>:update<CR>')
map('n', '<space>v', '<cmd>:Files<CR>')
map('n', '<space>t', '<cmd>:NvimTreeToggle<CR>')
map('n', '<space>f', '<cmd>:Rg<CR>')
